...
} from "../../../src/features/decisionPlugins/expressionDomains/expressionDomainTypeRegistry";
...
describe("decisionPlugins expression-domain pairwiseComparison", () => {
  it("registers pairwiseComparison for numericContinuous", () => {
    const entry = getExpressionDomainTypeEntryOrThrow("numericContinuous");
  ...
  it("registers pairwiseComparison for numericDiscrete", () => {
    const entry = getExpressionDomainTypeEntryOrThrow("numericDiscrete");
  ...
  it("keeps linguistic domains without pairwiseComparison", () => {
    expect(
      getExpressionDomainTypeEntryOrThrow("linguisticOrdinal").pairwiseComparison
    ).toBeUndefined();
    expect(
      getExpressionDomainTypeEntryOrThrow("linguisticFuzzy").pairwiseComparison
    ).toBeUndefined();
  });
