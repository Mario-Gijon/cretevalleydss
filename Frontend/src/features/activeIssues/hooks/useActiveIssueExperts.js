...
import { editExperts } from "../../../services/issue.service";
 ...
 * @returns {Object}
 */
export const useActiveIssueExperts = ({
  selectedIssue,
  initialExperts = [],
  showSnackbarAlert,
  refresh,
  ...
  /**
   * Correos de expertos ya presentes en el issue o
   * pendientes de añadirse en la edición actual.
   */
  ...
  /**
   * Lista de expertos disponibles para añadir al issue.
   */
  ...
  /**
   * Restablece por completo el estado del flujo de edición.
   *
   * @returns {void}
   */
  ...
  /**
   * Valida y decide si guardar directamente o abrir
   * la asignación de dominios para los nuevos expertos.
   *
   * @returns {Promise<void>}
   */
...
export default useActiveIssueExperts;