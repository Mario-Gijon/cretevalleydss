      ...
      >
        ...
        <Box sx={{ position: "relative", flex: 1, minHeight: 0, display: "flex" }}>
          {railItems.length === 0 ? (
            ...
            >
              {railItems.map((it) => {
                const accent = resolveActiveIssuesToneColor(it.tone).dot;
          ...
          {groupsFiltered.length === 0 ? (
            ...
            <Stack spacing={1.05} sx={{ pb: 0.5 }}>
              {groupsFiltered.map((g) => {
                const tone = g.tone || "info";
                const accent = alpha(resolveActiveIssuesToneColor(tone).dot, 0.55);
                const isServer = Boolean(g.isServer);
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <ActiveIssuesPill tone={tone}>{g.items.length}</ActiveIssuesPill>
                    </Box>
