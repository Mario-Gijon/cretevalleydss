...
const FinalRankingPanel = ({ ranking }) => <Box sx={resultsPanelSx}>
  <Stack direction="row" justifyContent="space-between" spacing={1}>
    <Stack direction="row" spacing={1} alignItems="center"><EmojiEventsOutlinedIcon sx={{ color: "secondary.light" }} /><Box><Typography component="h2" sx={{ fontSize: 18, fontWeight: 950 }}>Final ranking</Typography><Typography sx={{ color: "text.secondary", fontSize: 11.5 }}>Alternatives ranked by performance with original scores.</Typography></Box></Stack>
