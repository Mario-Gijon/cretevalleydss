...
export const dashboardKpiIconSx = (tone = "default") => ({
  ...
  color: tone === "winner" ? "success.light" : tone === "success" ? "success.light" : "secondary.light",
  bgcolor: tone === "winner" ? "rgba(63, 193, 139, 0.12)" : tone === "success" ? "rgba(63, 193, 139, 0.12)" : "rgba(44, 154, 199, 0.12)", border: "1px solid rgba(255,255,255,0.065)",
});
...
export const dashboardCardSx = (accent = "cyan") => ({
  ...
  border: accent === "green" ? "1px solid rgba(80, 205, 147, 0.22)" : "1px solid rgba(85, 199, 216, 0.20)",
  bgcolor: "rgba(9, 19, 30, 0.91)",
  background: accent === "green" ? "linear-gradient(150deg, rgba(44, 143, 102, 0.17), rgba(9, 19, 30, 0.94) 46%)" : "linear-gradient(150deg, rgba(27, 111, 145, 0.18), rgba(9, 19, 30, 0.94) 46%)",
...
export const dashboardInfoIconSx = (tone = "cyan") => ({ width: 30, height: 30, display: "grid", placeItems: "center", borderRadius: "50%", color: tone === "green" ? "success.light" : "secondary.light", bgcolor: tone === "green" ? "rgba(74,190,132,0.11)" : "rgba(50,157,199,0.11)" });
