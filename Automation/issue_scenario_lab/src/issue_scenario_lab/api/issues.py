...
class IssuesApi:
    ...
    def edit_experts(
        ...
        issue_id: str,
        *,
        experts_to_add: list[str],
        experts_to_remove: list[str],
        expert_weights_by_email: dict[str, float] | None = None,
    ) -> Any:
        ...
        return self.client.request(
            ...
            json={
                "expertsToAdd": experts_to_add,
                "expertsToRemove": experts_to_remove,
                **(
                    {"expertWeightsByEmail": expert_weights_by_email}
                    if expert_weights_by_email is not None
                    else {}
                ),
            },
        )
