...
# This model-specific request fixture is intentionally distinct from the
# canonical CreteValleyDSS global domain: pyDecision cost normalization needs
# strictly positive lower bounds for the labels used as costs.
