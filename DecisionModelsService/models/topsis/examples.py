...
TOPSIS_REQUEST_EXAMPLES: dict[str, dict[str, Any]] = {
    "basic_numeric_matrix": {
        ...
        "description": (
            "Executes TOPSIS with three alternatives, three criteria, two experts, "
        ...
        "value": {
            "context": {
                "issue": {
                    "id": "issue-topsis-001",
                    "name": "Supplier selection with TOPSIS",
...
TOPSIS_RESPONSE_EXAMPLES: dict[str, dict[str, Any]] = {
    "success": {
        ...
        "description": "Successful TOPSIS execution for the basic numeric matrix request.",
        "value": {
            "success": True,
                ...
                "rankedAlternatives": [
                    {
                        ...
                        "name": "Supplier B",
                        "score": 0.68106133190158,
                        "rank": 1,
                    },
                    {
                        "alternativeId": "alt-supplier-a",
                        "name": "Supplier A",
                        "score": 0.421921007539692,
                        "rank": 2,
                    },
                    {
                        "alternativeId": "alt-supplier-c",
                        "name": "Supplier C",
                        "score": 0.31893866809842014,
                        "rank": 3,
                    },
                ],
