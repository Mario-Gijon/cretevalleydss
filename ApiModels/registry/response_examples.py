        ...
        "value": {
            ...
            "data": {
                ...
                "rawOutput": {
                    ...
                    "q_values": [0.5874, 0.1125, 0.2786],
                    "s_values": [0.4812, 0.1033, 0.2298],
                    "r_values": [0.2511, 0.0624, 0.1417],
                    "v": 0.5,
                },
            },
        },
...
WASPAS_RESPONSE_EXAMPLES: dict[str, dict[str, Any]] = {
    "success": {
        ...
        "value": {
            ...
            "data": {
                "rankedAlternatives": [
                    {"alternativeId": None, "name": "A2", "score": 0.8421, "rank": 1},
                    {"alternativeId": None, "name": "A3", "score": 0.7342, "rank": 2},
                    {"alternativeId": None, "name": "A1", "score": 0.6138, "rank": 3},
                ],
                "collectiveEvaluations": {
                    "A1": {"Cost": 0.45, "Benefit": 0.62},
                    "A2": {"Cost": 0.31, "Benefit": 0.84},
                ...
                "rawOutput": {
                    ...
                    "weighted_sum_scores": [0.6427, 0.8614, 0.7512],
                    "weighted_product_scores": [0.5849, 0.8228, 0.7172],
                    "lambda": 0.5,
                },
            },
        },
